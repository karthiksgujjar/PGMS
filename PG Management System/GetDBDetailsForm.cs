        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string CreateDB_UseDB_CreateTables_Query = 
                               ...
                               "CREATE TABLE buildings(id INT(3) NOT NULL, building_name VARCHAR(100) NOT NULL, building_image VARCHAR(100) NOT NULL, PRIMARY KEY(id));" +

                               "CREATE TABLE floors(id VARCHAR(6) NOT NULL, building_id INT(3) NOT NULL, floor_name VARCHAR(100) NOT NULL, floor_image VARCHAR(200) NOT NULL, PRIMARY KEY(id), FOREIGN KEY(building_id) REFERENCES buildings(id));" +

                               "CREATE TABLE rooms(id VARCHAR(9) NOT NULL, floor_id VARCHAR(6) NOT NULL, room_no SMALLINT NOT NULL, room_image VARCHAR(300) NOT NULL, PRIMARY KEY(id), FOREIGN KEY(floor_id) REFERENCES floors(id));" +
